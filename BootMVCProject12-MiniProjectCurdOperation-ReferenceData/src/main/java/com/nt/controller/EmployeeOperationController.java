...
public class EmployeeOperationController {
	...
	public String addEmployee(RedirectAttributes attrs,@ModelAttribute("emp")Employee emp,BindingResult error) {
		...
		System.out.println("Model class object data::"+emp);
		System.out.println("EmployeeOperationController.addEmployee()");
	...
	public String showStateByCountry(@RequestParam("country") String country,@ModelAttribute("emp") Employee emp,Map<String,Object> map) {
		
		System.out.println("showStateByCountry()");
		//use service
		List<String> stateList=service.getStatesByCountry(country);
		//put statelist in model attribute
